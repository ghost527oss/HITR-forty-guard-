...
export const Filters: React.FC<FiltersProps> = ({
  ...
  return (
    <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 sm:p-5 shadow-lg space-y-4">
      ...
      <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-slate-950/80 border border-slate-750 focus:border-cyan-500 rounded-xl text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-cyan-500 transition-all"
          />
          {filters.search && (
            <button
        ...
        <div className="w-full md:w-64">
          <select
            ...
            className="w-full py-2.5 px-3 bg-slate-950/80 border border-slate-750 focus:border-cyan-500 rounded-xl text-xs font-semibold text-slate-200 focus:outline-none cursor-pointer"
          >
      ...
      {showAdvanced && (
        <div className="pt-4 border-t border-slate-800 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 animate-in fade-in duration-150">
          {/* Cost Filter */}
          <div>
            ...
            <select
              ...
              className="w-full py-1.5 px-2 bg-slate-950 border border-slate-750 rounded-lg text-xs text-slate-200 focus:outline-none cursor-pointer"
            >
          ...
          <div className="flex items-end">
            <button
              ...
              onClick={onReset}
              className="w-full flex items-center justify-center space-x-1.5 py-1.5 px-3 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-lg text-xs font-semibold border border-slate-700 transition-colors"
            >
      ...
      <div className="flex items-center justify-between text-xs text-slate-400 pt-1">
        <div>
          ...
          <span className="font-semibold text-slate-300">100 architectural cooling designs</span>
        </div>
