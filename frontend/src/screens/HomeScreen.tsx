...
const QUICK_ACTIONS: { view: View; label: string; icon: string; desc: string }[] = [
  { view: "map", label: "Heat Map", icon: "🗺️", desc: "See live temperature across your city" },
  { view: "assistant", label: "Heat Assistant", icon: "🤖", desc: "First aid, emergency, buildings & heat answers" },
  { view: "planner", label: "How much to change", icon: "🌳", desc: "Plan trees, shade & water by change level" },
  { view: "tools", label: "Tools", icon: "🧰", desc: "Architecture, farming & first-aid guides" },
];
